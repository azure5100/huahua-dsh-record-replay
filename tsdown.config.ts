 ...
 * and is served at /plugins/huahua-dsh-record-replay/client.js. Everything (react,
...
export default defineConfig({
  name: 'huahua-dsh-record-replay/client',
  ...
  outputOptions: {
    ...
    banner: 'window.__ModuleLoader__.load({ id: "huahua-dsh-record-replay", factory: (require) => {',
